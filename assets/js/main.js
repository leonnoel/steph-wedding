$(document).ready(function() {
    ...
    var target_date = new Date("November 19, 2016").getTime();
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Resort</div><h4 class="map-title script">Iberostar Rose Hall Suites</h4><div class="address"><span class="region">Address line goes here</span><br><span class="postal-code">Postcode</span><br><span class="city-name">City</span></div>'
        }
